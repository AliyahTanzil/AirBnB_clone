...
class TestAmenity(unittest.TestCase):
    ...
    def test_pep8_conformance_Amenity(self):
        ...
        self.assertEqual(
            result.total_errors, 0, "Found code style errors (and warings)."
        )
    ...
    def test_to_dict(self):
        ...
        self.assertEqual(my_dict["created_at"], self.A.created_at.isoformat())
        self.assertEqual(datetime, type(self.A.created_at))
        self.assertEqual(my_dict["__class__"], self.A.__class__.__name__)
